...
If you use python3, and you want export to xls use this version of the `xlwt <https://github.com/edschofield/xlwt>`_ if this `pull request <https://github.com/python-excel/xlwt/pull/32>`_ is not merged still.
